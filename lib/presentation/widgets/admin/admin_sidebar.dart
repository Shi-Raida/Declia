          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildSectionLabel(Tr.admin.section.principal.tr),
                  _buildNavItem(
                    route: AppRoutes.adminDashboard,
                    icon: Icons.dashboard_outlined,
                    label: Tr.admin.sidebar.dashboard.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminClients,
                    icon: Icons.people_outline,
                    label: Tr.admin.sidebar.clients.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminPlanning,
                    icon: Icons.calendar_month_outlined,
                    label: Tr.admin.sidebar.planning.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminGalleries,
                    icon: Icons.photo_library_outlined,
                    label: Tr.admin.sidebar.galleries.tr,
                  ),
                  const SizedBox(height: 8),
                  _buildSectionLabel(Tr.admin.section.commerce.tr),
                  _buildNavItem(
                    route: AppRoutes.adminOrders,
                    icon: Icons.shopping_bag_outlined,
                    label: Tr.admin.sidebar.orders.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminInvoicing,
                    icon: Icons.receipt_long_outlined,
                    label: Tr.admin.sidebar.invoicing.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminGiftCards,
                    icon: Icons.card_giftcard_outlined,
                    label: Tr.admin.sidebar.giftCards.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminPromotions,
                    icon: Icons.local_offer_outlined,
                    label: Tr.admin.sidebar.promotions.tr,
                  ),
                  const SizedBox(height: 8),
                  _buildSectionLabel(Tr.admin.section.outils.tr),
                  _buildNavItem(
                    route: AppRoutes.adminTasks,
                    icon: Icons.check_circle_outline,
                    label: Tr.admin.sidebar.tasks.tr,
                  ),
                  _buildNavItem(
                    route: AppRoutes.adminSettings,
                    icon: Icons.settings_outlined,
                    label: Tr.admin.sidebar.settings.tr,
                  ),
                ],
              ),
            ),
